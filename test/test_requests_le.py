...
class TestCreateWindow(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x01\xc5\x17\x00' '\x88\x2d\x38\x1c' \
            '\xf9\x77\x6d\x4b' '\xcd\xe6\xd3\x80' \
            '\x7b\xce\x06\xb3' '\xc3\x57\x00\x00' \
            '\x2f\x00\x86\x7a' '\xff\x7f\x00\x00' \
            '\x0f\x19\xd9\x51' '\x04\x87\x34\x03' \
            '\xbb\xe2\x34\x23' '\x3d\xf2\x92\x1c' \
            '\x07\x00\x00\x00' '\x06\x00\x00\x00' \
            '\x02\x00\x00\x00' '\x87\xb9\x21\x0b' \
            '\xbd\x1c\x02\x36' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x0a\xfa\xaf\x40' \
            '\x0d\x81\x66\x03' '\x34\x50\x74\x19' \
            '\x6b\xc3\x2f\x53'
...
class TestChangeWindowAttributes(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x02\x00\x12\x00' '\x91\xb4\x2f\x5a' \
            '\xff\x7f\x00\x00' '\x86\x31\x16\x2b' \
            '\xc7\x00\xe0\x0b' '\x03\x1b\x62\x0c' \
            '\x0f\xd9\x7a\x6c' '\x05\x00\x00\x00' \
            '\x07\x00\x00\x00' '\x02\x00\x00\x00' \
            '\xfb\x95\xa3\x44' '\x8f\x15\x8f\x7c' \
            '\x00\x00\x00\x00' '\x01\x00\x00\x00' \
            '\x45\x1a\x2a\x6a' '\x66\x09\x2c\x4f' \
            '\xcc\x8c\x4c\x6e' '\x05\x19\xe7\x49'
...
class TestGetWindowAttributes(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x03\x00\x02\x00' '\x0f\x87\xde\x05'
        ...
        self.reply_bin_0 = '\x01\x9d\xcb\x4a' '\x03\x00\x00\x00' \
            '\x30\x8b\x37\x0a' '\x5c\x3c\x8c\xa3' \
            '\xe0\x78\x5e\x51' '\xbc\x74\xb3\x2e' \
            '\x00\x00\xa2\x01' '\xea\x2c\xf3\x52' \
            '\x49\x65\xf8\x4d' '\x38\xb3\xe8\x15' \
            '\xed\xba\x00\x00'
...
class TestDestroyWindow(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x04\x00\x02\x00' '\xa2\x35\xeb\x14'
...
class TestDestroySubWindows(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x05\x00\x02\x00' '\xcf\x9d\x92\x30'
...
class TestChangeSaveSet(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x06\x01\x02\x00' '\x43\xdf\xeb\x51'
...
class TestReparentWindow(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x07\x00\x04\x00' '\x7e\x92\x4a\x47' \
            '\x51\xc1\xa1\x57' '\x0b\xeb\x8e\xe2'
...
class TestMapWindow(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x08\x00\x02\x00' '\xda\x37\x52\x1d'
...
class TestMapSubwindows(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x09\x00\x02\x00' '\x25\xd4\x1c\x04'
...
class TestUnmapWindow(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x0a\x00\x02\x00' '\x34\x73\x61\x28'
...
class TestUnmapSubwindows(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x0b\x00\x02\x00' '\xb6\x10\x46\x22'
...
class TestConfigureWindow(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x0c\x00\x0a\x00' '\xda\x32\xbc\x3a' \
            '\x7f\x00\x00\x00' '\x01\x9b\x00\x00' \
            '\xb1\xf8\x00\x00' '\x2d\xf0\x00\x00' \
            '\x47\xa8\x00\x00' '\xe5\xd3\x00\x00' \
            '\xa5\xab\xa4\x32' '\x04\x00\x00\x00'
...
class TestCirculateWindow(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x0d\x00\x02\x00' '\x58\x3e\x92\x1f'
...
class TestGetGeometry(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x0e\x00\x02\x00' '\x82\x59\xdb\x47'
        ...
        self.reply_bin_0 = '\x01\xa1\x11\x96' '\x00\x00\x00\x00' \
            '\x60\xf6\xeb\x72' '\xb9\xb2\xda\x9b' \
            '\x5f\xff\xed\x82' '\x2e\x18\x00\x00' \
...
class TestQueryTree(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x0f\x00\x02\x00' '\xbd\xdc\x08\x06'
        ...
        self.reply_bin_0 = '\x01\x00\xec\x87' '\x07\x00\x00\x00' \
            '\x3f\x53\x4c\x7c' '\x22\x2b\x2e\x6e' \
            '\x07\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x80\xdf\x09\x0e' '\x41\x86\x50\x50' \
            '\x84\x10\x63\x65' '\x66\xea\x09\x36' \
            '\xc2\x9c\x22\x08' '\xe7\x84\xd9\x30' \
            '\xc4\xe8\x80\x7f'
...
class TestInternAtom(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x00\xc8\xb8' '\x00\x00\x00\x00' \
            '\x88\x9a\x42\x57' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestGetAtomName(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x11\x00\x02\x00' '\x24\xe8\xbb\x44'

        self.reply_args_0 = {
            'name': 'WM_CLASS',
            'sequence_number': 17674,
            }
        self.reply_bin_0 = '\x01\x00\x0a\x45' '\x02\x00\x00\x00' \
...
class TestChangeProperty(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x12\x01\x06\x00' '\xe5\x3a\x48\x0e' \
            '\xf5\xf3\xa6\x37' '\x28\x2a\x14\x3a' \
            '\x08\x00\x00\x00' '\x00\x00\x00\x00'
        ...
        self.req_bin_1 = '\x12\x02\x07\x00' '\xc2\x12\x1c\x70' \
            '\x11\x78\xb7\x21' '\x85\xb4\x13\x40' \
        ...
        self.req_bin_2 = '\x12\x00\x07\x00' '\x8e\x13\xd1\x74' \
            '\x2e\x48\x6d\x6f' '\xf6\x23\x34\x26' \
        ...
        self.req_bin_3 = '\x12\x01\x06\x00' '\x7d\x20\xf3\x4d' \
            '\x95\x15\x91\x13' '\xfd\x30\x9a\x61' \
        ...
        self.req_bin_4 = '\x12\x01\x08\x00' '\xf9\x40\xaa\x63' \
            '\x48\x19\xe3\x43' '\x44\xbd\x13\x00' \
        ...
        self.req_bin_5 = '\x12\x00\x08\x00' '\xc5\x31\x7f\x02' \
            '\x3b\xc6\xec\x76' '\x6a\x14\x7a\x70' \
        ...
        self.req_bin_6 = '\x12\x02\x06\x00' '\xba\x50\x5d\x27' \
            '\xaf\x08\x6b\x07' '\x92\xbd\x62\x70' \
        ...
        self.req_bin_7 = '\x12\x02\x09\x00' '\x4e\x9b\xf7\x0a' \
            '\x12\x73\x35\x3e' '\xf7\xe2\xdc\x08' \
...
class TestDeleteProperty(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x13\x00\x03\x00' '\xb0\xa6\x5b\x61' \
            '\xc3\x18\x07\x62'
...
class TestGetProperty(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x14\x00\x06\x00' '\xe2\x93\xd6\x3c' \
            '\x12\x6a\x60\x46' '\x4d\x1c\xee\x21' \
            '\x71\x03\xac\x6f' '\xfc\xf5\x29\x36'
        ...
        self.reply_bin_0 = '\x01\x08\x02\x37' '\x00\x00\x00\x00' \
            '\x6c\x1d\x08\x45' '\xbd\xa6\x6e\x5d' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
        ...
        self.reply_bin_1 = '\x01\x08\x4b\x34' '\x01\x00\x00\x00' \
            '\xf9\x01\xe7\x27' '\x17\x0f\x61\x7f' \
        ...
        self.reply_bin_2 = '\x01\x08\xb8\xa6' '\x01\x00\x00\x00' \
            '\xb6\x39\x14\x38' '\x56\x68\x40\x42' \
        ...
        self.reply_bin_3 = '\x01\x10\xdb\x1f' '\x00\x00\x00\x00' \
            '\x5b\xa8\xc3\x1c' '\xb3\x0c\x47\x2b' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
        ...
        self.reply_bin_4 = '\x01\x10\x04\x97' '\x02\x00\x00\x00' \
            '\x60\x2b\x75\x1d' '\xef\xdc\x30\x1c' \
            '\x03\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x01\x00\x02\x00' '\x03\x00\x00\x00'
        ...
        self.reply_bin_5 = '\x01\x10\x1a\x13' '\x02\x00\x00\x00' \
            '\xc0\x59\xc8\x50' '\x44\xbc\x4e\x1d' \
            '\x04\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x01\x00\x02\x00' '\x03\x00\x04\x00'
        ...
        self.reply_bin_6 = '\x01\x20\xe1\xe7' '\x00\x00\x00\x00' \
            '\x53\xac\x08\x6e' '\x64\xc8\x12\x09' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
        ...
        self.reply_bin_7 = '\x01\x20\xb0\x3d' '\x03\x00\x00\x00' \
            '\x14\x65\xa1\x55' '\xc0\xe5\x6c\x1b' \
            '\x03\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x01\x00\x00\x00' '\x02\x00\x00\x00' \
            '\x03\x00\x00\x00'
...
class TestListProperties(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x15\x00\x02\x00' '\x5c\x76\xf0\x10'
        ...
        self.reply_bin_0 = '\x01\x00\x6e\xec' '\x17\x00\x00\x00' \
            '\x17\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\xbf\xfe\xbe\x77' '\x78\x5e\x18\x49' \
            '\xf2\x02\x81\x3c' '\xe9\x9f\x6e\x64' \
            '\x0d\x41\x5c\x67' '\x62\x29\x60\x18' \
            '\xc9\x21\x69\x0c' '\x0b\x41\x2d\x37' \
            '\x96\x66\x38\x36' '\x4e\xff\xc7\x3b' \
            '\xdb\xa0\x52\x5d' '\xd8\x22\x31\x56' \
            '\x37\x24\xf9\x7d' '\xbe\xdb\x99\x0c' \
            '\x09\xb1\x89\x33' '\xaf\xed\x6e\x2b' \
            '\x8a\x6c\x4b\x6e' '\xda\xb8\xd4\x1f' \
            '\x46\x93\x59\x18' '\x59\xb8\x6c\x39' \
            '\xb2\xcb\x00\x36' '\xb8\x16\xa8\x23' \
            '\x6a\x68\xfa\x1f'
...
class TestSetSelectionOwner(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x16\x00\x04\x00' '\xab\x10\xb9\x38' \
            '\x7b\xd3\x40\x6e' '\x6e\x82\x71\x46'
...
class TestGetSelectionOwner(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x17\x00\x02\x00' '\xb7\xa0\x7a\x06'

        self.reply_args_0 = {
            'owner': 1795366313,
            'sequence_number': 65489,
            }
        self.reply_bin_0 = '\x01\x00\xd1\xff' '\x00\x00\x00\x00' \
            '\xa9\x1d\x03\x6b' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestConvertSelection(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x18\x00\x06\x00' '\xb0\x19\x08\x7c' \
            '\x54\x44\x93\x76' '\x8e\x36\xa2\x6c' \
            '\x22\x84\x4a\x15' '\xb4\x00\x2a\x3e'
...
class TestSendEvent(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x19\x01\x0b\x00' '\x58\x42\x3e\x3a' \
            '\xb0\xaf\x25\x36' '\x0c\x00\x00\x00' \
            '\x95\xdb\x5c\x1b' '\x43\x67\xf3\x0f' \
            '\xa3\x61\x40\xfc' '\xa0\x44\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00'
...
class TestGrabPointer(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x1a\x01\x06\x00' '\xe7\x03\x6a\x7f' \
            '\xb8\x8e\x01\x00' '\xae\x39\xfb\x25' \
            '\x22\xb3\xfe\x7b' '\x26\x00\x23\x4a'

        self.reply_args_0 = {
            'sequence_number': 49083,
            'status': 197,
            }
        self.reply_bin_0 = '\x01\xc5\xbb\xbf' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestUngrabPointer(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x1b\x00\x02\x00' '\x6e\x22\x52\x07'
...
class TestGrabButton(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x1c\x01\x06\x00' '\x03\xe6\x5d\x40' \
            '\x71\xda\x00\x01' '\x2b\x03\x42\x0a' \
            '\x2e\xed\xc9\x17' '\xcc\x00\x2d\xad'
...
class TestUngrabButton(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x1d\x9e\x03\x00' '\x1e\x53\x59\x0f' \
            '\x05\xe4\x00\x00'
...
class TestChangeActivePointerGrab(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x1e\x00\x04\x00' '\x01\xbd\x84\x1f' \
            '\xed\x9b\x19\x4c' '\xf1\x9e\x00\x00'
...
class TestGrabKeyboard(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x1f\x00\x04\x00' '\x9c\x30\xb6\x4a' \
            '\x6f\x05\xeb\x42' '\x01\x00\x00\x00'

        self.reply_args_0 = {
            'sequence_number': 15837,
            'status': 219,
            }
        self.reply_bin_0 = '\x01\xdb\xdd\x3d' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestUngrabKeyboard(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x20\x00\x02\x00' '\xff\xb6\xa9\x32'
...
class TestGrabKey(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x21\x01\x04\x00' '\x1a\x01\x67\x26' \
            '\xa0\x51\xe0\x00' '\x00\x00\x00\x00'
...
class TestUngrabKey(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x22\xff\x03\x00' '\xa0\x17\x80\x7f' \
            '\xae\x13\x00\x00'
...
class TestAllowEvents(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x23\x01\x02\x00' '\x6d\xd2\xf2\x21'
...
class TestQueryPointer(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x26\x00\x02\x00' '\x2a\x1c\x75\x77'
        ...
        self.reply_bin_0 = '\x01\x01\x36\xe1' '\x00\x00\x00\x00' \
            '\x4a\x4b\x4d\x2f' '\xf4\xe3\x31\x14' \
            '\xe3\xe9\x5a\xd9' '\xaf\xcd\x61\xfd' \
            '\xc3\xa7\x00\x00' '\x00\x00\x00\x00'
...
class TestGetMotionEvents(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x27\x00\x04\x00' '\xf9\x56\x01\x01' \
            '\x1a\x0d\x97\x68' '\x5a\xbe\x52\x26'
        ...
        self.reply_bin_0 = '\x01\x00\x89\x18' '\x0a\x00\x00\x00' \
            '\x05\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x0d\x42\xea\x54' '\x3f\xf7\x0e\x91' \
            '\x51\x40\xc7\x0e' '\x98\x8d\x42\xc6' \
            '\xab\x08\xdd\x22' '\xd0\xcc\x23\xdb' \
            '\xeb\x45\x10\x1a' '\x8c\xd0\x86\xa1' \
            '\x23\xb9\x88\x3e' '\xfb\xf2\x75\xeb'
...
class TestTranslateCoords(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x28\x00\x04\x00' '\xad\x4e\x38\x36' \
            '\x1b\xfb\x6a\x23' '\x73\x80\xef\xe1'
        ...
        self.reply_bin_0 = '\x01\x01\xcc\x43' '\x00\x00\x00\x00' \
            '\xc5\xe9\xe0\x5e' '\x10\xc6\x51\xb6' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestWarpPointer(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x29\x00\x06\x00' '\xd8\xd8\x3d\x01' \
            '\xfb\x83\xa2\x09' '\x28\xf0\xcd\xf2' \
            '\x20\x8c\xd2\xd5' '\xfb\xc9\xce\x92'
...
class TestSetInputFocus(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x2a\x00\x03\x00' '\x8b\xb3\x75\x27' \
            '\x2a\xed\x11\x73'
...
class TestGetInputFocus(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\xe5\x7a\xdc' '\x00\x00\x00\x00' \
            '\x44\x10\x10\x73' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestQueryKeymap(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x00\x3f\x32' '\x02\x00\x00\x00' \
            '\x9a\x9f\x8d\xe3' '\xf1\xb4\xcf\x93' \
            '\xf7\xee\xfc\xe7' '\xf0\x83\xde\xaa' \
            '\xf7\xe6\xee\xe7' '\xa2\xe4\x8d\xef' \
            '\xed\x9c\xe8\xba' '\xa7\xe5\x9d\x83'
...
class TestOpenFont(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x2d\x00\x05\x00' '\xcb\x28\x05\x2a' \
...
class TestCloseFont(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x2e\x00\x02\x00' '\xba\x40\xa3\x6e'
...
class TestQueryFont(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x2f\x00\x02\x00' '\x25\x0e\xc3\x7b'
        ...
        self.reply_bin_0 = '\x01\x00\xbd\xb5' '\x12\x00\x00\x00' \
            '\x36\x80\x8d\xf5' '\x62\xc4\x5e\xdb' \
            '\x3b\xde\x02\xac' '\x00\x00\x00\x00' \
            '\x41\xae\xe3\x88' '\x5c\xd4\xef\xa9' \
            '\xde\xa7\x3e\xd9' '\x00\x00\x00\x00' \
            '\x89\xb8\x95\x4d' '\xde\x4f\x01\x00' \
            '\xb4\xb3\xa5\x00' '\x65\xb5\x6e\xf7' \
            '\x03\x00\x00\x00' '\xb0\x16\xbb\x23' \
            '\x9f\x6e\x1c\x52' '\xc2\xb2\x9c\xfc' \
            '\x19\xc4\x49\xf7' '\xa6\x8e\x73\xf8' \
            '\xad\x96\x3e\xfa' '\xb7\xa1\xc4\x8d' \
            '\x30\xb7\xc7\xba' '\xd6\xa7\xfd\xcc' \
            '\xf3\xc0\xeb\xb0' '\x3a\xc9\xf4\x41'
...
class TestQueryTextExtents(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x30\x01\x04\x00' '\x56\xad\xb2\x56' \
        ...
        self.reply_bin_0 = '\x01\xf3\xf4\x9d' '\x00\x00\x00\x00' \
            '\x38\xa6\x97\xc5' '\x0d\x80\x70\xa4' \
            '\x20\x25\x06\xb7' '\x80\x5c\x3c\xca' \
            '\x3b\xbd\xcc\xd3' '\x00\x00\x00\x00'
...
class TestListFonts(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x31\x00\x04\x00' '\x92\x77\x05\x00' \
        ...
        self.reply_bin_0 = '\x01\x00\xc0\x71' '\x05\x00\x00\x00' \
            '\x03\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
...
class TestListFontsWithInfo(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x32\x00\x04\x00' '\x7e\x37\x06\x00' \
        ...
        self.reply_bin_0 = '\x01\x08\xfc\xcb' '\x0b\x00\x00\x00' \
            '\x8d\x95\xc4\x8a' '\x76\xc1\x62\xd0' \
            '\x91\xaa\xb2\xd1' '\x00\x00\x00\x00' \
            '\x65\xdf\x72\xd5' '\x87\x9c\x4a\x99' \
            '\x1a\x83\x6f\x3f' '\x00\x00\x00\x00' \
            '\x28\x7a\xae\xd9' '\x92\x13\x01\x00' \
            '\xb5\xd0\x98\x01' '\xc9\xbe\xfc\x9e' \
            '\x86\x0d\xfa\x53' '\x49\xe4\x91\x3c' \
            '\xfa\xfd\x59\x73' '\x66\x6f\x6e\x74' \
            '\x66\x6f\x6e\x74'
...
class TestGetFontPath(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x00\x69\x02' '\x04\x00\x00\x00' \
        ...
        self.reply_bin_1 = '\x01\x00\x7e\xc0' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestCreatePixmap(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x35\xe2\x04\x00' '\xc3\x8b\xa5\x0d' \
            '\xec\xc3\x6b\x36' '\xd9\x2d\x48\xf5'
...
class TestFreePixmap(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x36\x00\x02\x00' '\xee\xeb\x4c\x42'
...
class TestCreateGC(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x37\x00\x1b\x00' '\x80\xaa\x39\x50' \
            '\x0a\xbc\x26\x23' '\xff\xff\x7f\x00' \
            '\x00\x00\x00\x00' '\xe2\x7a\xe6\x1f' \
            '\xe4\x6f\x96\x6c' '\x76\xe2\x6d\x3a' \
            '\x95\xe6\x00\x00' '\x02\x00\x00\x00' \
            '\x03\x00\x00\x00' '\x01\x00\x00\x00' \
            '\x03\x00\x00\x00' '\x01\x00\x00\x00' \
            '\x55\xc7\x6b\x4e' '\x2b\x73\x11\x5c' \
            '\x9c\xc0\x00\x00' '\x50\xea\x00\x00' \
            '\xc5\x1e\x21\x46' '\x01\x00\x00\x00' \
            '\x01\x00\x00\x00' '\xc2\xbc\x00\x00' \
            '\x2d\xa1\x00\x00' '\xf2\x4d\xa6\x1f' \
            '\x9f\xd1\x00\x00' '\xe2\x00\x00\x00' \
            '\x01\x00\x00\x00'
...
class TestChangeGC(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x38\x00\x1a\x00' '\x91\x1e\x72\x60' \
            '\xff\xff\x7f\x00' '\x01\x00\x00\x00' \
            '\x4d\x74\x93\x24' '\xf5\x49\xc8\x22' \
            '\x65\xec\xec\x28' '\x24\xc5\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x02\x00\x00\x00' '\x02\x00\x00\x00' \
            '\x00\x00\x00\x00' '\xfc\xce\x2c\x34' \
            '\x3e\xbd\x74\x45' '\x38\xb5\x00\x00' \
            '\x79\x9a\x00\x00' '\xb7\xd7\xc7\x35' \
            '\x01\x00\x00\x00' '\x01\x00\x00\x00' \
            '\x06\xd9\x00\x00' '\xa9\xed\x00\x00' \
            '\xca\x3c\xff\x61' '\xb0\xb0\x00\x00' \
...
class TestCopyGC(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x39\x00\x04\x00' '\xd1\xed\x3d\x6d' \
            '\x48\x0d\x0a\x7a' '\x03\x12\xa3\x35'
...
class TestSetDashes(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x3a\x00\x06\x00' '\x89\x3e\xc1\x33' \
            '\x16\x2b\x09\x00' '\xdf\xc5\xcd\x9c' \
            '\x9c\xb7\x83\xab' '\xd6\x00\x00\x00'
...
class TestSetClipRectangles(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x3b\x00\x07\x00' '\x10\x79\x19\x3b' \
            '\x62\x86\x25\xb0' '\x5c\xbb\x35\x90' \
            '\xac\x9f\xe0\x07' '\x0a\xb2\xae\xc7' \
            '\xe9\x07\xe6\xa4'
        ...
        self.req_bin_1 = '\x3b\x00\x03\x00' '\xa8\xc1\xd6\x29' \
            '\xad\xe0\x26\xb0'
...
class TestFreeGC(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x3c\x00\x02\x00' '\x1a\x1b\x42\x60'
...
class TestClearArea(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x3d\x01\x04\x00' '\x68\x2e\x4b\x20' \
            '\x67\x8a\x76\x82' '\x8d\x8a\xf9\xff'
...
class TestCopyArea(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x3e\x00\x07\x00' '\x8c\x26\xcc\x2c' \
            '\x80\x45\x38\x53' '\xcf\xa9\xff\x63' \
            '\xc6\xd2\xca\xdf' '\x9a\xf8\x51\x99' \
            '\x32\x06\xdb\x27'
...
class TestCopyPlane(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x3f\x00\x08\x00' '\xf7\xe1\x28\x10' \
            '\x6f\x28\xb1\x55' '\x5e\x97\x30\x48' \
            '\xae\x9b\xd5\xd8' '\x66\xe1\x4f\x95' \
            '\xd9\x9b\xb8\xbf' '\x0a\xe6\xa9\x0e'
...
class TestPolyPoint(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x40\x01\x06\x00' '\x13\x2d\xc6\x32' \
            '\x07\xe3\x85\x5b' '\x0d\xe8\x85\xfa' \
            '\xba\x8d\x42\x83' '\x9e\xa7\x06\xd6'
...
class TestPolyLine(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x41\x00\x08\x00' '\x8f\xa9\xd5\x36' \
            '\xf2\x7e\x6f\x2f' '\xa6\x89\xb5\xd7' \
            '\xa9\xcf\xf1\x8c' '\x1b\xe2\xfd\xeb' \
            '\x41\xcc\x5f\x8f' '\xf3\xfc\x65\xe3'
...
class TestPolySegment(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x42\x00\x05\x00' '\x32\x31\x83\x0d' \
            '\x4e\x20\xfb\x7a' '\x42\xc0\x56\xab' \
            '\xe6\xeb\x70\xe8'
...
class TestPolyRectangle(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x43\x00\x09\x00' '\x3f\x84\x5b\x22' \
            '\xc9\x15\x05\x6d' '\xb8\xd0\x3f\xe9' \
            '\x5d\xb5\x0c\x70' '\x31\xdd\x9e\xfa' \
            '\xde\x45\x17\xcf' '\x59\xc4\x67\xbd' \
            '\x12\x70\x69\xbb'
...
class TestPolyArc(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x44\x00\x0c\x00' '\xa9\x47\xf6\x0a' \
            '\xbe\xaf\x2b\x5c' '\x81\xe9\x01\x8b' \
            '\xd0\xe1\x2f\x3f' '\x05\xbb\x83\xcd' \
            '\x22\xb0\xa5\x83' '\xfe\xd9\x5e\x2f' \
            '\xf0\x9a\x53\xe5' '\x39\xab\xcd\xef' \
            '\xcd\xb3\x72\x47' '\x4a\x81\x68\xf8'
...
class TestFillPoly(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x45\x00\x07\x00' '\x42\x14\xea\x0b' \
            '\x9b\x0c\x5e\x1c' '\x02\x00\x00\x00' \
            '\x0d\xbe\x4a\xe0' '\xb5\xd7\x08\xd2' \
            '\x56\xbe\xb4\xe4'
...
class TestPolyFillRectangle(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x46\x00\x07\x00' '\x87\xbe\x2e\x20' \
            '\x08\x88\x72\x0f' '\xdc\xc9\x1b\xbc' \
            '\x62\x88\x80\x6d' '\xbc\xde\x03\xaa' \
            '\x3a\xb4\x15\x46'
...
class TestPolyFillArc(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x47\x00\x06\x00' '\x2f\xbc\xfa\x3d' \
            '\x0a\x7a\xbf\x5c' '\x75\x98\x2f\x8f' \
            '\xa5\x89\x5b\xc3' '\x83\x97\x7b\x9b'
...
class TestPutImage(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x48\x02\x09\x00' '\xba\xc6\x27\x43' \
            '\xbc\x04\x3a\x24' '\xa2\x1a\x7f\x32' \
            '\xe4\x9c\xca\x96' '\x81\xc4\x00\x00' \
...
class TestGetImage(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x49\x01\x05\x00' '\xd4\xb8\xb5\x7c' \
            '\x47\xc6\x93\xd8' '\x33\x21\x75\xde' \
            '\x46\x9f\xd5\x3e'
        ...
        self.reply_bin_0 = '\x01\xef\x62\x93' '\x07\x00\x00\x00' \
            '\xcc\xba\x15\x3c' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
...
class TestPolyText8(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x4a\x00\x08\x00' '\x52\xd7\x61\x38' \
            '\x5c\x0b\x9a\x17' '\x86\x86\x84\xf7' \
...
class TestPolyText16(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x4b\x00\x07\x00' '\x94\xc0\x26\x3d' \
            '\x6a\x43\x3b\x69' '\xe4\xb2\x68\x89' \
...
class TestImageText8(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x4c\x06\x06\x00' '\x26\x0c\x92\x50' \
            '\xc9\x9b\xdd\x06' '\xf2\x92\x7b\xc7' \
...
class TestImageText16(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x4d\x08\x08\x00' '\x38\xc7\xe4\x26' \
            '\x11\xb7\x38\x7f' '\x0b\x8f\x16\xe1' \
...
class TestCreateColormap(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x4e\x01\x04\x00' '\x6b\x34\x37\x65' \
            '\x25\x17\xe4\x1c' '\x5e\x22\xe4\x42'
...
class TestFreeColormap(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x4f\x00\x02\x00' '\xe9\x01\xab\x39'
...
class TestCopyColormapAndFree(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x50\x00\x03\x00' '\x9e\xa3\xab\x38' \
            '\xc4\x14\x1a\x6e'
...
class TestInstallColormap(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x51\x00\x02\x00' '\xb3\x5a\xb9\x7e'
...
class TestUninstallColormap(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x52\x00\x02\x00' '\xfb\x64\x17\x27'
...
class TestListInstalledColormaps(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x53\x00\x02\x00' '\xc4\x33\x7e\x4f'

        self.reply_args_0 = {
            'cmaps': [1309197997, 1589346714],
            'sequence_number': 62114,
            }
        self.reply_bin_0 = '\x01\x00\xa2\xf2' '\x02\x00\x00\x00' \
            '\x02\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\xad\xc6\x08\x4e' '\x9a\x81\xbb\x5e'
...
class TestAllocColor(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x54\x00\x04\x00' '\x18\x96\x99\x1a' \
            '\xcf\x36\x68\xa9' '\x0c\x29\x00\x00'
        ...
        self.reply_bin_0 = '\x01\x00\x52\x2d' '\x00\x00\x00\x00' \
            '\x24\x14\xae\x01' '\xe0\x73\x00\x00' \
            '\x52\x69\x02\x4c' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestAllocNamedColor(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x55\x00\x05\x00' '\x70\xb1\x48\x25' \
        ...
        self.reply_bin_0 = '\x01\x00\x06\x3c' '\x00\x00\x00\x00' \
            '\x58\xd2\x7d\x5a' '\x43\xb4\xc7\x74' \
            '\x48\xb0\x98\xec' '\xe5\xc9\x63\xa0' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestAllocColorCells(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x56\x01\x03\x00' '\xad\x83\x82\x77' \
            '\x69\x6d\xdd\x8b'
        ...
        self.reply_bin_0 = '\x01\x00\x49\x18' '\x14\x00\x00\x00' \
            '\x11\x00\x03\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x06\x0c\xe6\x52' '\xf5\xea\x46\x74' \
            '\x23\x39\xcf\x69' '\xd8\xe2\x24\x09' \
            '\xc2\xca\x3d\x15' '\x29\x84\x60\x27' \
            '\x00\x19\xde\x5f' '\x16\x35\xdc\x48' \
            '\x34\xe7\xf1\x24' '\x41\xb2\xeb\x0f' \
            '\x66\xe9\x26\x58' '\x73\x2c\x91\x59' \
            '\x20\xac\xa9\x78' '\xc9\xf8\x0f\x40' \
            '\x1d\x30\x35\x3f' '\x91\xd6\x4c\x0a' \
            '\x49\x1e\x1b\x05' '\x81\x48\x4d\x37' \
            '\xe5\x82\x42\x29' '\x18\xce\x0c\x20'
        ...
        self.reply_bin_1 = '\x01\x00\x49\xf6' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestAllocColorPlanes(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x57\x01\x04\x00' '\x98\x8c\xa0\x49' \
            '\x73\xf3\xe4\xff' '\x6e\xac\xb9\x45'
        ...
        self.reply_bin_0 = '\x01\x00\x99\xea' '\x04\x00\x00\x00' \
            '\x04\x00\x00\x00' '\xd9\xda\x3b\x17' \
            '\xee\x7e\xec\x4a' '\xab\xfd\x40\x51' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x6f\x45\x27\x05' '\x27\xa9\xcd\x60' \
            '\x85\xe6\x39\x3c' '\xed\x02\x65\x53'
...
class TestFreeColors(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x58\x00\x14\x00' '\x80\xc6\xde\x41' \
            '\xc9\xb3\x7a\x7e' '\x1d\x61\xf1\x3e' \
            '\x6b\xbd\xae\x0b' '\xd2\xa3\x8a\x2c' \
            '\x21\x84\xaa\x2a' '\xc3\x43\xc7\x55' \
            '\x1d\x57\xca\x6d' '\x38\xad\x37\x2a' \
            '\xf2\x9a\xca\x58' '\x51\x08\xe5\x24' \
            '\x1d\x28\xfc\x78' '\x45\x1e\x23\x68' \
            '\xfc\x03\x6a\x46' '\xd1\x47\x38\x3a' \
            '\x9f\xc8\x42\x28' '\x4f\xb6\x61\x29' \
            '\xfd\x0a\x2f\x7c' '\xa5\x9a\xbc\x33'
...
class TestStoreColors(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x59\x00\x0e\x00' '\x96\x2f\xef\x0b' \
            '\xd0\x8e\x2e\x54' '\x5c\x8b\x60\x6a' \
            '\xd5\x30\xae\x00' '\x70\x5f\xd3\x60' \
            '\x7a\xa0\xcc\xc2' '\xe8\x34\xc6\x00' \
            '\xa7\x0d\xbe\x76' '\xb8\x70\x0d\xb3' \
            '\xf6\x1f\xfc\x00' '\xdd\xe5\xef\x4d' \
            '\x05\x3e\x62\x29' '\x76\x8d\xc6\x00'
...
class TestStoreNamedColor(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x5a\xff\x05\x00' '\x2b\xf9\xda\x74' \
            '\x5d\x43\x11\x3b' '\x04\x00\x00\x00' \
            '\x62\x6c\x75\x65'
...
class TestQueryColors(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x5b\x00\x0a\x00' '\xa1\x54\x33\x1f' \
            '\x67\x03\x0a\x0f' '\xda\xd5\x83\x6a' \
            '\x28\x45\xcb\x3f' '\xf0\xf0\xb9\x5b' \
            '\x95\x35\x23\x41' '\x47\x50\x00\x23' \
            '\x46\x66\xd8\x6a' '\x05\xad\x78\x7d'
        ...
        self.reply_bin_0 = '\x01\x00\xdb\x7d' '\x0a\x00\x00\x00' \
            '\x05\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\xd0\x62\x13\xec' '\x99\x82\x00\x00' \
            '\x3a\xe1\x53\xdd' '\x71\x47\x00\x00' \
            '\x73\xca\xcf\x6a' '\x3b\xef\x00\x00' \
            '\x79\x82\x3d\xd2' '\x1f\x49\x00\x00' \
            '\x21\x4d\xab\x96' '\xb8\xff\x00\x00'

        self.req_args_1 = {
            'cmap': 1183862146,
            'pixels': [],
            }
        self.req_bin_1 = '\x5b\x00\x02\x00' '\x82\x4d\x90\x46'
...
class TestLookupColor(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x5c\x00\x05\x00' '\xac\x06\x06\x13' \
            '\x07\x00\x00\x00' '\x6f\x63\x74\x61' \
            '\x72\x69\x6e\x00'
        ...
        self.reply_bin_0 = '\x01\x00\x56\x8a' '\x00\x00\x00\x00' \
            '\x01\x59\xbd\x8d' '\x93\x8b\x1c\x75' \
            '\x0d\x53\x1b\x31' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestCreateCursor(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x5d\x00\x08\x00' '\x53\xee\x47\x59' \
            '\xe4\x17\x31\x49' '\x02\x24\xe6\x1d' \
            '\xc3\xc6\x21\x0c' '\xe6\xbe\xd5\xb4' \
            '\xe8\xcf\x73\x63' '\x3d\xaa\x4a\xd2'
...
class TestCreateGlyphCursor(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x5e\x00\x08\x00' '\xca\x77\x8b\x7d' \
            '\x11\x6f\x67\x3f' '\x87\x05\xbe\x04' \
            '\x15\x81\x7e\x97' '\xc6\xde\xeb\xdf' \
            '\x47\x71\x1e\x87' '\x84\x75\x39\xb9'
...
class TestFreeCursor(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x5f\x00\x02\x00' '\xf9\xc4\x7a\x34'
...
class TestRecolorCursor(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x60\x00\x05\x00' '\x3f\x38\xd0\x53' \
            '\x5c\x28\xb8\x78' '\x25\xf8\x55\x57' \
            '\xa3\xb1\xb5\xa6'
...
class TestQueryBestSize(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x61\x02\x03\x00' '\x26\xab\x19\x6d' \
            '\x21\xdc\xe7\x61'
        ...
        self.reply_bin_0 = '\x01\x00\xbf\x51' '\x00\x00\x00\x00' \
            '\x45\xb8\xa5\xc2' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestQueryExtension(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x00\x75\xdf' '\x00\x00\x00\x00' \
            '\x00\x88\xd0\xf5' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestListExtensions(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x02\x57\xff' '\x04\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
...
class TestChangeKeyboardMapping(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x64\x14\x3e\x00' '\xd1\x03\x00\x00' \
            '\x50\x0a\x96\x5f' '\x8f\x60\x8c\x37' \
            '\xcc\xc8\x99\x0c' '\x1a\xa6\x1e\x51' \
            '\x20\xad\xb0\x6f' '\x72\x75\xca\x38' \
            '\xb4\x07\xd5\x58' '\x4f\x66\xa3\x73' \
            '\x35\x08\xe3\x05' '\x70\x07\xe8\x65' \
            '\x45\x13\x8d\x25' '\xf6\xca\xfa\x2f' \
            '\xf3\x07\xa2\x12' '\x06\x42\xfd\x43' \
            '\xaa\x54\x70\x48' '\x32\x47\x71\x65' \
            '\x32\x06\xc2\x15' '\x89\xa2\x1b\x0a' \
            '\x05\xac\x77\x6f' '\x5a\xab\x52\x4f' \
            '\xb7\x82\xd3\x1e' '\xc8\x94\xd7\x74' \
            '\x73\xae\x51\x12' '\xd9\xf5\x06\x3b' \
            '\x57\x54\x82\x20' '\xaa\x8b\xae\x20' \
            '\x5e\xef\x33\x01' '\x76\x37\xfe\x66' \
            '\x93\xd4\x5a\x73' '\x18\xf4\xbb\x56' \
            '\x91\x8b\x38\x14' '\xfe\x99\x8a\x38' \
            '\x8f\x7e\x3b\x2c' '\xb4\x8c\x35\x4b' \
            '\x4e\xbe\xc8\x51' '\x5a\xc1\x4f\x36' \
            '\xf7\x37\x03\x20' '\x43\xeb\x32\x6c' \
            '\x4f\xf1\x7f\x19' '\xdd\xa0\x3d\x31' \
            '\x01\xc3\xd9\x3d' '\xa5\xc1\x5c\x1e' \
            '\x45\xc3\x34\x49' '\xf4\x6f\x93\x49' \
            '\x6a\x88\x10\x7f' '\x10\x1f\xca\x25' \
            '\xec\x48\x2d\x7d' '\xe5\xdf\x40\x54' \
            '\x4f\x2c\x22\x23' '\xad\x5c\x70\x48' \
            '\x1b\x47\xc8\x57' '\xfe\x4e\x51\x5f' \
            '\xfe\x14\x47\x06' '\x5b\xba\x9e\x4d' \
            '\x7c\xc2\x94\x3f' '\x4d\x5c\xbb\x73' \
            '\x8c\x02\xa2\x24' '\x62\x0c\x41\x66' \
            '\x4c\x4e\xb4\x4d' '\x63\xda\x18\x2d'
...
class TestGetKeyboardMapping(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x65\x00\x02\x00' '\xcf\xd6\x00\x00'
        ...
        self.reply_bin_0 = '\x01\x03\x9e\x7e' '\x3c\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x8b\x61\x47\x5c' '\x8a\x0f\x60\x54' \
            '\x71\xa1\x4e\x6b' '\x10\x6f\x6a\x50' \
            '\x89\xbb\xa2\x73' '\xff\x49\xbb\x52' \
            '\xdc\x1c\x8b\x27' '\xf0\xe4\x6c\x38' \
            '\x75\x79\x2f\x4a' '\x01\xf7\xbd\x5d' \
            '\x8e\x7d\x89\x0b' '\xe4\x2d\xc6\x25' \
            '\xf5\x73\xad\x5f' '\xb3\x5f\x7b\x16' \
            '\xbc\x9c\xea\x10' '\x3d\x50\x0b\x45' \
            '\x44\xc5\x59\x7c' '\x77\xf8\xf2\x43' \
            '\x23\x24\xed\x74' '\x41\xed\x4c\x6a' \
            '\x4e\x65\xe4\x20' '\x8e\x6f\x8f\x69' \
            '\x8e\x30\xad\x3d' '\xd3\x03\x3b\x67' \
            '\xbd\x41\x8f\x5f' '\x7c\x05\x5b\x2b' \
            '\x87\xe1\xbd\x0e' '\x60\x16\x40\x7b' \
            '\x6b\x53\x04\x12' '\x62\x47\xb6\x7b' \
            '\x49\x16\x19\x6e' '\x1a\x22\xb3\x5c' \
            '\x55\xbf\x6e\x7d' '\xbc\x7e\xcf\x7b' \
            '\x58\xba\xfc\x66' '\x81\xb7\xd1\x2e' \
            '\x15\x11\x35\x65' '\x24\x16\xc8\x01' \
            '\xc1\x66\xae\x44' '\xb5\x6d\x36\x3a' \
            '\x8b\x3d\x1f\x56' '\x63\x43\x0f\x56' \
            '\x75\xdd\xd2\x4a' '\x59\xf8\x44\x69' \
            '\x15\x7c\x5b\x78' '\xfa\x48\xde\x0d' \
            '\x47\xe0\xed\x1d' '\xf9\x01\x34\x03' \
            '\x7e\x9b\x2e\x71' '\x74\x32\xdc\x47' \
            '\x08\x1b\x27\x75' '\xaa\xc2\x55\x1c' \
            '\xfa\x7e\x17\x08' '\x96\x17\x74\x69' \
            '\x6a\xd0\x66\x74' '\xea\x2a\xae\x26' \
            '\xe1\x09\x43\x34' '\x90\x36\xe4\x11' \
            '\x0f\x19\x1f\x79' '\x2f\x6b\xf5\x26'
...
class TestChangeKeyboardControl(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x66\x00\x0a\x00' '\xff\x00\x00\x00' \
            '\x8c\x00\x00\x00' '\xf1\x00\x00\x00' \
            '\x5d\x91\x00\x00' '\x10\xba\x00\x00' \
            '\xd5\x00\x00\x00' '\x01\x00\x00\x00' \
            '\xf9\x00\x00\x00' '\x01\x00\x00\x00'
...
class TestGetKeyboardControl(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x00\x11\x38' '\x05\x00\x00\x00' \
            '\x5e\x4f\x52\x6f' '\xaa\x92\xa2\xe6' \
            '\xb9\x01\x00\x00' '\xdf\x93\xb5\x8c' \
            '\xbe\xb4\xf9\x84' '\xaf\xb8\xf9\xed' \
            '\x8c\xd7\xc5\xfd' '\xad\xb2\x98\x8f' \
            '\xec\xba\xd4\xd2' '\xcc\x82\xe4\x9f' \
            '\x90\xc8\x88\xe1'
...
class TestBell(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x68\xed\x01\x00'
...
class TestChangePointerControl(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x69\x00\x03\x00' '\x60\x92\x82\x90' \
            '\xd5\x9f\x00\x01'
...
class TestGetPointerControl(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x00\x92\x07' '\x00\x00\x00\x00' \
            '\xca\x04\x72\xca' '\xac\x3d\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestSetScreenSaver(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x6b\x00\x03\x00' '\x1e\xa9\x21\x96' \
            '\x00\x02\x00\x00'
...
class TestGetScreenSaver(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x00\x26\x87' '\x00\x00\x00\x00' \
            '\x25\xbf\x71\x7a' '\x01\x01\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestChangeHosts(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x6d\x01\x03\x00' '\x02\x00\x04\x00' \
            '\x8d\xc0\xf9\x85'
...
class TestListHosts(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x01\xcd\x75' '\x04\x00\x00\x00' \
            '\x02\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
...
class TestKillClient(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x71\x00\x02\x00' '\xde\xcc\x4f\x3d'
...
class TestRotateProperties(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x72\x00\x0f\x00' '\xb8\xf7\x4f\x7f' \
            '\x0c\x00\x61\xc3' '\xe6\xca\x68\x33' \
            '\x4c\x5b\xd2\x57' '\xb8\xa3\xc1\x3e' \
            '\xc4\x2a\x71\x74' '\xfe\x11\x69\x09' \
            '\xf6\x42\x58\x0a' '\xe8\x14\xdd\x4d' \
            '\xb1\x35\x69\x08' '\x02\x73\x34\x23' \
            '\x67\x06\x09\x51' '\xc9\xfe\x30\x46' \
            '\xf6\x59\xa0\x29'
...
class TestSetPointerMapping(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x74\x05\x03\x00' '\xcd\x8c\xd9\xed' \
            '\xd3\x00\x00\x00'
        ...
        self.reply_bin_0 = '\x01\xe2\xd0\xb8' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestGetPointerMapping(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x05\x13\x6b' '\x02\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x9b\xb9\x9d\xab' '\xba\x00\x00\x00'
...
class TestSetModifierMapping(EndianTest):
    def setUp(self):
        ...
        self.req_bin_0 = '\x76\x02\x05\x00' '\x18\x6d\xaa\x5f' \
            '\x27\xec\x11\xd4' '\x17\x18\xbd\xcf' \
            '\x8e\x96\x8f\x54'
        ...
        self.reply_bin_0 = '\x01\x8f\x2a\x5b' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00'
...
class TestGetModifierMapping(EndianTest):
    def setUp(self):
        ...
        self.reply_bin_0 = '\x01\x02\xd7\xce' '\x04\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\x00\x00\x00\x00' '\x00\x00\x00\x00' \
            '\xaa\xc0\xde\xb8' '\xf7\x99\x5a\x93' \
            '\x36\xa8\x39\x1b' '\xd8\x5e\xc3\x92'
